...
class CORE_PP_424_PTH350_200_MVIA140_75(edb_stackup_wrapper_class):
    def __init__(self, edb_object):
        super().__init__(edb_object)

    def setup(self,
              coreMaterial='EM528', coreThickness='355um',
              buMaterial='EM528', buThickness='40um'):
        ...
        self.dielList = {
            ...
            #########################################
            # EM528 materials
            'PP_EM528_30um': {'name': 'EMC_EM528B_PP1017_28um_10GHz',
                            'Dk': 3.33,
                            'tanD': 0.0048},
            'PP_EM528_40um': {'name': 'EMC_EM528B_PP1027_41um_10GHz',
                            'Dk': 3.42,
                            'tanD': 0.0048},
            'CCL_EM528_355um': {'name': 'EMC_EM528_CCL356um_10GHz',
                              'Dk': 4.07,
                              'tanD': 0.0054},
            'CCL_EM528_400um': {'name': 'EMC_EM528_CCL406um_10GHz',
                              'Dk': 3.97,
                              'tanD': 0.0053},
            #########################################
            # Doosan DS8502SQ materials
            'PP_DS8502SQ_30um': {'name': 'DOOSAN_DS8502SQ_PP1017_30um_10GHz',
                               'Dk': 3.19,
                               'tanD': 0.003},
            'PP_DS8502SQ_40um': {'name': 'DOOSAN_DS8502SQ_PP1027_40um_10GHz',
                               'Dk': 3.27,
                               'tanD': 0.003},
            'CCL_DS8502SQ_355um': {'name': 'DOOSAN_DS8502SQ_CCL355um_10GHz',
                                 'Dk': 3.63,
                                 'tanD': 0.003},
            'CCL_DS8502SQ_400um': {'name': 'DOOSAN_DS8502SQ_CCL400um_10GHz',
                                 'Dk': 3.75,
                                 'tanD': 0.003},
            }

        self.stackThickness = {'UFT': 140,
                               'SMT': 20,
                               'L01': 15,
