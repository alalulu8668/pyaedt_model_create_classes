    ...
    def setup(self):
        ...
        self.dielList = {
            ...
            'SolderMask': {'name': '7730L',
                           'Dk': 3.9,
                           'tanD': 0.03},
            'PrePreg': {'name': 'Mitsubishi_GHPL972LF_LD_PP_10GHz',
                        'Dk': 3.4,
                        'tanD': 0.004},
            'Core': {'name': 'Mitsubishi_HL972LF_LD_CORE_10GHz',
                     'Dk': 3.4,
                     'tanD': 0.004}}
        ...
        dielCore = self.dielList['Core']['name']
        dielPP = self.dielList['PrePreg']['name']
    ...
    def setup(self):
        ...
        self.dielList = {
            ...
            'SolderMask': {'name': '7730L',
                           'Dk': 3.9,
                           'tanD': 0.03},
            'PrePreg': {'name': 'Ajinimoto_ABF_GL102_5p8GHz',
                        'Dk': 3.3,
                        'tanD': 0.0044},
            'Core': {'name': 'Mitsubishi_HL972LF_LD_CORE_10GHz',
                     'Dk': 3.4,
        ...
        bumpPads = [
            ['BUMP_PAD_50', ['L01'], '50um', '0um', 'copper', 100],
            ['BUMP_PAD_80', ['L01'], '80um', '0um', 'copper', 100],
            ['BUMP_PAD_110', ['L01'], '110um', '0um', 'copper', 100],
            ]
        for v in bumpPads: self.padStack.append(v)
        # Ball pad definitions
