...
#### CSP BALL to SL_L14 MULTI SIGNALS
def BALL_TOP_TO_L14_SL_DIFF(prjPath,
                           stackup,
                           ballPattern,
                           sigNamePattern=[],
                           ballPitch='1000um',
    ...
    #### ADD SIGNAL LINES ON L14
    # Add fanout line
    edb.add_design_variable('l14_fanout_length', '100um')
    edb.add_design_variable('l14_fanout_angle', '45deg')
    lineStructList, lineNamesList, lineObjList, foLine_EndPoints = \
        add_signal_fanout_from_vias_diff(
            ...
            layer='L14',
            lineLength='l14_fanout_length', lineWidth='tune1_width',
            diffLineSpace='diffLineSpace', fanOutAngle='l14_fanout_angle',
            voids=['L14', 'gndPlaneL14', 'tune1_width + 2*lineSpace'],
            gndLayers=gnd_layers)
    # Add first tuneline
    ...
    lineStructList, lineNamesList, lineObjList, tuneLine2_EndPoints = \
            add_signal_lines_diff(
                ...
                diffLineSpace='diffLineSpace',
                voids=['L14', 'gndPlaneL14', 'tune2_width + 2*lineSpace'],
                gndLayers=gnd_layers)
    ...
    lineStructList, lineNamesList, lineObjList, deembedLine_EndPoints = \
            add_signal_lines_diff(
                ...
                diffLineSpace='diffLineSpace',
                voids=['L14', 'gndPlaneL14', 'lineWidth + 2*lineSpace'],
                gndLayers=gnd_layers,
                endStyle='Flat')
